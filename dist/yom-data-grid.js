...
function render($data, $opt) {
    ...
    if (type == "set") {
        ...
        _$out_ += '<div class="form-group"><input name="value" type="' + $encodeHtml(filterOption.onlyNumber ? "number" : "text") + '" value="' + $encodeHtml(filterCriteria.value || "") + '" class="form-control" maxlength="' + $encodeHtml(filterOption.maxLength || "") + '" /></div>';
    }
    _$out_ += "</div>";
